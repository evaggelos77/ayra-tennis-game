...
(function () {
  ...
  css.textContent = [
    ...
    '.pb-brandlabel{text-align:center;font-size:12px;color:var(--muted,#9db2d4);margin:12px 0 4px;font-weight:700;letter-spacing:.02em}',
    '.pb-brand{display:flex;gap:12px;justify-content:center;margin:2px 0 6px}',
    '.pb-bbtn{flex:1;max-width:150px;padding:11px 8px;border-radius:var(--r,14px);border:1px solid var(--line,rgba(120,190,255,.2));background:rgba(4,16,30,.5);color:var(--muted,#cfe4ff);font-weight:900;font-size:15px;letter-spacing:.05em;cursor:pointer;transition:box-shadow .16s,border-color .16s,transform .14s,background .16s}',
    '.pb-bbtn:hover{transform:translateY(-2px)}',
    '.pb-bbtn.ayra.on{border-color:#35d6ff;background:rgba(53,214,255,.18);color:#fff;box-shadow:inset 0 0 0 1px rgba(53,214,255,.4),0 10px 26px rgba(53,214,255,.28)}',
    '.pb-bbtn.pwr.on{border-color:#ff3b3b;background:rgba(255,59,59,.16);color:#fff;box-shadow:inset 0 0 0 1px rgba(255,59,59,.4),0 10px 26px rgba(255,59,59,.28)}',
